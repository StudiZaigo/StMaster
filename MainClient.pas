...
var
  uStClient: TuStClient;

implementation

{$R *.dfm}

procedure TuStClient.SetValues;
var
  ws: wideString;
begin
...
procedure TuStClient.btnStatusGetClick(Sender: TObject);
begin
...
procedure TuStClient.btnMoveClick(Sender: TObject);
var
  i: integer;
  a: Integer;
begin
...
procedure TuStClient.btnOpenCloseClick(Sender: TObject);
var
  i: integer;
begin
...
procedure TuStClient.btnRotateClick(Sender: TObject);
var
  i: integer;
  d: single;
begin
...
procedure TuStClient.FormCreate(Sender: TObject);
begin
