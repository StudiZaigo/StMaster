...
//    procedure cbxRotatorActive1Click(Sender: TObject);
//    procedure btnRotatorIndexClick(Sender: TObject);
...
procedure TForm1.btnStatusGetClick(Sender: TObject);
begin
...
begin
  ...
  and TryStrToInt(edtAzimuth_Move.Text, a) then
    if StMaster.GetRotatorActive(0) then
      StMaster.Move(i - 1, a);
end;
